namespace DoFactory.HeadFirst.Proxy.VirtualProxy
{
    ...
    /// </summary>
    public class FormVirtualProxy : Form
    {
        private Button buttonTestImageProxy;
        ...
        {
            pictureBox.Image = new ImageProxy().Image;
        }
        ...
        private class ImageProxy
        {
            ...
            public Image PlaceHolderImage()
            {
                return new Bitmap(Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("DoFactory.HeadFirst.Proxy.VirtualProxy.PlaceHolder.jpg"));
            }
