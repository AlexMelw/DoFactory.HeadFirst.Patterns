namespace DoFactory.HeadFirst.Combined.MVC
{
    ...
    public class FormMain : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.textBoxCurrentBPM.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F,
            ...
            // labelMVC
            // 
            this.labelMVC.Font = new System.Drawing.Font("Microsoft Sans Serif", 11F, System.Drawing.FontStyle.Bold,
        ...
        private void FormMain_Load(object sender, EventArgs e)
        {
            ...
            _controller.Attach(textBoxCurrentBPM);
            _controller.Attach(panelColor);
        }
        ...
        {
            _controller.BeatsPerMinute = trackBarBPM.Value;
            textBoxBPM.Text = trackBarBPM.Value.ToString();
        }
    }
}